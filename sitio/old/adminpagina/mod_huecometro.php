...
$dtshuemt = $proceso->listarHuecometroID($id);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div id="wrapper">
 <section id="cuerpoPrin">
    ...
    <form action="controlador/ctr_huecometro_cred.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="5">
        <tr>
          <td><a href="huecometro_home.php">Listado de Huecometro</a> / Modificar Huecometro</td>
          <td align="right">
           </td>
        </tr>
        <tr>
          <td colspan="2"><table width="100%" border="0" cellspacing="5">
            ...
            <tr>
              ...
              <td>
              <input type="text" name="pavimento" id="pavimento" onKeyPress="return campos(event, 'num')" maxlength="7" value="<?php echo $dtshuemt[0]['hcmtr_pavimentado'];?>">
              </td>
            </tr>
            <tr>
              <td>Inversion Total</td>
              <td><input type="text" name="inversion" id="inversion" onKeyPress="return campos(event, 'num')" maxlength="5" value="<?php echo $dtshuemt[0]['hcmtr_inversion'];?>"></td>
            </tr>
            <tr>
              <td>Seleccione la fecha</td>
              <td><input type="text" id="datepicker" name="datepicker"  value="<?php echo $dtshuemt[0]['hcmtr_fecha'];?>"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
